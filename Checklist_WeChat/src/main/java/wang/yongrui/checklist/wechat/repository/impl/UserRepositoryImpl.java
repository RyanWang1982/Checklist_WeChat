...
public class UserRepositoryImpl extends SimpleJpaRepository<UserEntity, String> implements UserRepository {
	 ...
	 * findOneByWeChatUnionId(java.lang.String)
	 */
	@Override
	public UserEntity findOneByWeChatUnionId(String weChatUnionId) {
		return super.findOne((root, criteriaQuery, criteriaBuilder) -> {
			...
			return criteriaBuilder.and(criteriaBuilder.equal(root.get(UserEntity_.weChatUnionId), weChatUnionId));
		});
	}
